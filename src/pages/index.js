...
export function  Home () {
  ...
  return (
    <div className="max-w-[1276px] mx-auto p-4 h-centered flex items-center justify-center">
      <div className="max-w-[358px] lg:max-w-[530px] mx-auto px-8 py-12 lg:px-16 lg:py-20 bg-white rounded-2xl">
        ...
        <div className="flex flex-col items-center gap-8 mt-[72px]">
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 lg:w-16 h-[1px] bg-gray-400"></div>
            <span className='block text-gray-400 text-sm lg:text-base font-medium'>Ou entre em uma sala</span>
            <div className="w-10 lg:w-16 h-[1px] bg-gray-400"></div>
          </div>
          ...
          <div className='w-full flex flex-col items-center justify-center gap-4'>
            <div className='w-full'>
              ...
              <input type="text" id="roomCode" name="roomCode" placeholder="Digite o código da sala" className="px-4 py-4 rounded-lg border border-gray-500 text-gray-500 placeholder:text-gray-500 w-full" />
            </div>
